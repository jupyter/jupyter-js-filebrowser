...
var FileBrowserViewModel = (function () {
    ...
    Object.defineProperty(FileBrowserViewModel.prototype, "renamed", {
        /**
    ...
    FileBrowserViewModel.prototype.newUntitled = function (type) {
        ...
        return this._contents.newUntitled(this._path, { type: type, ext: ext }).then(function (contents) {
            _this.refresh();
            return contents;
        });
    };
    ...
    FileBrowserViewModel.prototype.rename = function (path, newPath) {
        ...
        return this._contents.rename(path, newPath).then(function (contents) {
            _this.refresh();
            _this.renamed.emit([current, contents]);
            return contents;
        });
    };
    /**
     ...
     */
    FileBrowserViewModel.renamedSignal = new phosphor_signaling_1.Signal();
                ...
                if (this._pendingSelect) {
                    setTimeout(function () {
                        if (_this._pendingSelect) {
                            handleEdit(current, _this._editNode).then(function (result) {
                                if (result) {
                                    var text = current.getElementsByClassName(ROW_TEXT_CLASS)[0];
                                    _this._model.rename(current.textContent, _this._editNode.value).catch(function (error) {
