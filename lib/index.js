...
var FileBrowser = (function (_super) {
    ...
    Object.defineProperty(FileBrowser.prototype, "itemsOpened", {
        /**
     ...
     */
    FileBrowser.prototype.get = function (item) {
        return this._model.contents.get(item.path, { type: "file" }).then(function (msg) {
            return msg.content;
        });
    };
    /**
    ...
    FileBrowser.prototype._listContents = function () {
        ...
        if (currentDir) {
            var path = '';
            var last = currentDir.lastIndexOf('/');
            if (last !== -1) {
     ...
     */
    FileBrowser.itemsOpenedSignal = new phosphor_signaling_1.Signal();
    return FileBrowser;
